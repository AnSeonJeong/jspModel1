...
<br>
	...
	if(!CalendarUtil.nvl(syear)) {	// 넘어온 파라미터가 있음
	...
	<table border="1">
		...
		<tr>
			<td colspan="7" align="center">
				<%=pp %>&nbsp;&nbsp;<%=p %>&nbsp;&nbsp;&nbsp;&nbsp;
				<font color="#000" style="font-size:50px;font-family:fantasy">
					<%=String.format("%d년&nbsp;&nbsp;%2d월", year, month) %>
				</font>
				&nbsp;&nbsp;&nbsp;&nbsp;<%=n %>&nbsp;&nbsp;<%=nn %>
			</td>
		</tr>
		<tr height='50' style="background-color: #044b61; color: white;">
			<th>일</th>
			<th>월</th>
			<th>화</th>
			<th>수</th>
	...
	<table border="1">
		...
		<%	
			for(int i = 0; i < searchlist.size(); i++) {
				CalendarDto dto = searchlist.get(i);
		%>
			<tr>
				<th><%=i+1 %></th>
				<td>
...
function searchBtn() {
	...
	location.href = "calendar.jsp?choice=" + choice + "&search=" + search;
}
</script>
</body>
</html>
